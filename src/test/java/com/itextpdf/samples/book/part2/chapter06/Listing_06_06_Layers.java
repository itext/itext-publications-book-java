...
public class Listing_06_06_Layers extends GenericTest {
    ...
    public void manipulatePdf(String dest) throws IOException, SQLException {
        ...
        PdfFont font = PdfFontFactory.createFont(StandardFontNames.ZAPFDINGBATS, true);
    ...
    public void createOriginalPdf(String filename) throws IOException {
        ...
        Paragraph p = new Paragraph("Foobar Film Festival")
                .setFont(PdfFontFactory.createFont(StandardFontNames.HELVETICA))
                .setFontSize(22)
        ...
        over.setFontAndSize(PdfFontFactory.createFont(StandardFontNames.HELVETICA), 36);
